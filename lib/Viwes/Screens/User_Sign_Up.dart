...
//Text(name),
                              ...
                              buildTextField(Icons.location_city, "Link GPS Or Address",
                                ...
                                children: [
                                 ...
                                 if (formkey.currentState!.validate())
                                 {
                                   ...
                                   try {
                                     ...
                                     {
                                       ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('This email already in use')));
                                     }
                                   }catch(ex){
                                     ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('please fill email and password')));
